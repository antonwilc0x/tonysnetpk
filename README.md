...
- [TypeSharp](https://marketplace.visualstudio.com/items?itemName=bonelol.typesharp)
- [F# Language Server](https://marketplace.visualstudio.com/items?itemName=georgewfraser.fsharp-language-server)
